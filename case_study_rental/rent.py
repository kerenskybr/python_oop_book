class Property:
	...
	# Without self, this method wont be affected by super()	
	def prompt_init():
		return dict(square_feet=input("Enter the square_feet: "),
...
# Nao é  necessario chamar init ou super aqui
# pois ambas classes herdadas chamam super e nao sabemos
# a ordem que elas irao tomar
